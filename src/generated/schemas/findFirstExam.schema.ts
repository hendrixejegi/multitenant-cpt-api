...
export const ExamFindFirstSelectSchema: z.ZodType<Prisma.ExamSelect> = z.object({
...
export const ExamFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    tenant_id: z.boolean().optional(),
    title: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const ExamFindFirstSchema: z.ZodType<Prisma.ExamFindFirstArgs> = z.object({ select: ExamFindFirstSelectSchema.optional(), include: z.lazy(() => ExamIncludeObjectSchema.optional()), orderBy: z.union([ExamOrderByWithRelationInputObjectSchema, ExamOrderByWithRelationInputObjectSchema.array()]).optional(), where: ExamWhereInputObjectSchema.optional(), cursor: ExamWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ExamScalarFieldEnumSchema, ExamScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ExamFindFirstArgs>;

export const ExamFindFirstZodSchema = z.object({ select: ExamFindFirstSelectSchema.optional(), include: z.lazy(() => ExamIncludeObjectSchema.optional()), orderBy: z.union([ExamOrderByWithRelationInputObjectSchema, ExamOrderByWithRelationInputObjectSchema.array()]).optional(), where: ExamWhereInputObjectSchema.optional(), cursor: ExamWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ExamScalarFieldEnumSchema, ExamScalarFieldEnumSchema.array()]).optional() }).strict();